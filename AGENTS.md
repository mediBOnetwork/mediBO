<!-- BEGIN agent_memory -->
<!-- AUTO-GENERATED for generic. Do not edit inside these markers — regenerated
     every session by memory_render.sh from Supabase agent_memory. This file
     carries the rules INLINE because generic has no @import mechanism. -->
