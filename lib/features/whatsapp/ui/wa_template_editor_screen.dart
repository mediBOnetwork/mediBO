...
class _MediaBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // WhatsApp renders *bold*, _italic_ and ~strike~ — the customer never sees
    // the markers. The backend already split the message into styled segments,
    // so the bubble paints them; no asterisks are parsed here. body_plain is the
    // marker-stripped text, used only when segments are absent, and
    // body_rendered is the last resort.
