...
class _AdminCompanyScreenState extends State<AdminCompanyScreen> with SingleTickerProviderStateMixin {
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Expanded(child: Text(r['company_name'] ?? '—', style: const TextStyle(fontSize: 15, fontWeight: FontWeight.w700, color: Color(0xFF111827)))),
            _StatusChip(r['status'] ?? 'pending'),
          ]),
          const SizedBox(height: 8),
          _InfoRow(icon: Icons.person_outlined, text: r['contact_person'] ?? '—'),
