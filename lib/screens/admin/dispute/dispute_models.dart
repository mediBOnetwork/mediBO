...
///
/// CHANGE #545 — p_date is OMITTED: it defaults to admin_active_date(), the
/// date the ONE Dashboard picker set, so a past-date admin view still never
/// leaks a wrong-day dispute chip (e.g. into the Pack tab's dispute index).
/// The key must be ABSENT, never present-with-null — an explicit null reads as
/// "all dates".
