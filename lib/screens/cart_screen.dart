...
class _CartScreenState extends State<CartScreen> {
  ...
  Future<void> _placeOrder() async {
    ...
    try {
      // Insert and read back order_code (auto-generated by DB trigger).
      final insertedRows = await Supabase.instance.client.from('orders').insert({
        'user_id':       userId,
      ...
      final displayCode = insertedRows.isNotEmpty
          ? orderDisplayId(insertedRows.first as Map<String, dynamic>)
          : orderDisplayId({'id': orderNumber, 'created_at': DateTime.now().toIso8601String()});
