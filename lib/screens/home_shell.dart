...
class _LoginPanelContentState extends State<_LoginPanelContent> {
  ...
  void _onEmailChanged() {
    ...
    if (empty != _emailEmpty) setState(() => _emailEmpty = empty);
  }
  ...
  Future<void> _passwordSignIn() async {
    ...
    try {
      ...
      // panel closes via _authSub signedIn listener; _AppRoot routes by is_admin()
              ...
              children: [
                ...
                SizedBox(
                  ...
                  child: FilledButton(
                    ...
                    style: FilledButton.styleFrom(
                      backgroundColor: _emailEmpty ? Colors.white : const Color(0xFF1B5E20),
                      foregroundColor: _emailEmpty ? const Color(0xFF374151) : Colors.white,
                      side: _emailEmpty
                    ...
                    child: _loading
                        ? SizedBox(
                            width: 22, height: 22,
                            child: CircularProgressIndicator(
                              color: _emailEmpty ? const Color(0xFF4285F4) : Colors.white,
                              strokeWidth: 2.5,
                            ),
                          )
                        : _emailEmpty
