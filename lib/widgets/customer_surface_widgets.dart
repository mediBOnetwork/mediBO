...
// CMD #2112 — RegistrationBanner (the orange block at the top of Home) is
// DELETED. The one ask now rides the bottom stack's bar slot, beside the
// update bar, so there is one banner shape in the app and only ever one of
// them on screen. `customer_registration_bar()` is what draws it.
